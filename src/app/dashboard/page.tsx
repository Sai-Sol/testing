      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="lg:col-span-3">
          ...
          <CardContent className="flex flex-wrap items-center justify-center gap-8 py-6">
            <div className="flex flex-col items-center justify-center h-16 w-40 p-4 bg-muted rounded-lg fill-current text-foreground/80 dark:grayscale dark:brightness-200">
